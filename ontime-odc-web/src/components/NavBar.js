          ...
          {!handBugger ? (
            ...
            >
              <FaTimes
                ...
                size={33}
                color="white"
                onClick={() => setHandBugger(false)}
              />
              <nav className="">
                <ul className="mt-16 p-4 text-white">
                  <li className="m-2 text-xl">
                    <Link to="/dashboard" onClick={() => setHandBugger(false)}>
                      Dashboard
                    </Link>
                  </li>
                  <li className="m-2 text-xl">
                    <Link to="/about" onClick={() => setHandBugger(false)}>
                      About
                    </Link>
                  </li>
                  <li className="m-2 text-xl">
                    <Link to="/contact" onClick={() => setHandBugger(false)}>
                      Contact
                    </Link>
                  </li>
